...
def get_senn_parser():
    ...
    parser.add_argument('--nconcepts', type=int, default=10, help='number of concepts')
    ...
    parser.add_argument('--theta_arch', type=str, default='simple', help="Parametrizer architecture", choices= ['simple','alexnet', 'vgg8','vgg11_bn', 'vgg11', 'vgg16', 'resnet'])
    ...
    parser.add_argument('--epochs', type=int, default=100, help='number of epochs for train [default: 10]')
